...
c.stroke();
    ...
    // Fe + 
    c.fillStyle = 'white';
    c.fillText('At the center of every Hemoglobin lies four Polypeptide chains of protein. Each alpha and beta chain contain a single iron deposit...', canvas.width/2, canvas.height/4.6, canvas.width/1.1,);
